...
<script type="text/javaScript">
	function select_board(unq) {
		var url = "boardDetail.do?unq=" + unq;
    ...
    function link_search() {
    	...
    	b.pageIndex.value = 1;
		b.action = "<c:url value='/boardList.do'/>";
       	b.submit();
    }
    ...
    <div class="bg-faded p-4 my-4">
     	<form id="pageVO" name="board" method="post">
			...
			<div class="table-responsive">
				<table class="table table-hover table-bordered">
					...
					<tr>
						...
						<th class="table-success">fid</th>
						<th class="table-success">thread</th>
					</tr>
						...
						<tr>
							...
							<td style="text-align: left">
								<a href="javascript:select_board('<c:out value="${list.unq}"/>')">
									<c:set var="len" value="${fn:length(list.thread)-1}"/>
							...
							<td align="center"><c:out value="${list.fid}"/></td>
							<td align="center"><c:out value="${list.thread}"/></td>
						</tr>
					</c:forEach>
				</table>
			</div>
			...
			<div id="sysbtn" align="right" style="margin-right: 10px">
				<a href="javascript:fn_action();" class="text-heading btn btn-secondary col-lg-2" style="font-weight:bold;">Write</a>
			</div>
		</form>
     </div>
