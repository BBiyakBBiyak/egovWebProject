...
// 내용체크
	...
	if(value == 'S') {
		...
		b.action = "<c:url value='/boardInsert.do'/>";
	} else if (value == 'L') {
...
<body>
    ...
    <div class="container">
   		...
   		<div class="bg-faded p-4 my-4" align="center">
            <hr class="divider">
            <h2 class="text-center text-lg text-uppercase my-0"><strong>Board</strong></h2>
            <hr class="divider">
            <div class="col-lg-12" style="padding: 10px" align="right">
				<input type="button" class="text-heading btn btn-secondary col-lg-2" style="font-weight:bold;" value="List" onclick="fn_action('L')">
        	</div>
            <form name="board" id="board" method="post" enctype="multipart/form-data">
				...
				<table class="table" style="width: 70%;">
			 	...
			 	<div class="form-group" style="float:center">
					<div class="col-lg-12 text-center">
						...
						<input type="button" onclick="fn_action('S')" class="text-heading btn btn-secondary col-lg-2" style="font-weight:bold;" value="Submit">
					
						<!-- <input type="button" id="submitBtn" class="text-heading btn btn-secondary col-lg-12" style="font-weight:bold;" value="Submit"> -->
						<input type="button" onclick="fn_action('R')" class="text-heading btn btn-secondary col-lg-2" style="font-weight:bold;" value="Reset">
					</div>
                </div>
			</div>
            </form>
